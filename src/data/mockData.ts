...
export const dashboards: Record<DashboardId, DashboardData> = {
  province: {
    ...
    metrics: [
      ...
      { label: "材料站累计入库金额", value: "¥ 12.45", unit: "亿元", icon: ArrowDownCircle, status: "normal" },
      { label: "材料站累计出库金额", value: "¥ 10.82", unit: "亿元", icon: ArrowUpCircle, status: "normal" },
    ...
    materialRankingPanel: {
      ...
      icon: Boxes,
      items: [
        { name: "变压器 (220kV)", value: "1.24 亿元", city: "国网沈阳供电公司", station: "沈阳铁西中心库" },
        { name: "隔离开关 (500kV)", value: "0.85 亿元", city: "国网大连供电公司", station: "大连金普一号库" },
        { name: "断路器 (110kV)", value: "0.72 亿元", city: "国网鞍山供电公司", station: "鞍山钢铁备件库" },
        { name: "互感器 (35kV)", value: "0.58 亿元", city: "国网抚顺供电公司", station: "抚顺石油专用库" },
        { name: "绝缘子 (复合)", value: "0.42 亿元", city: "国网本溪供电公司", station: "本溪钢铁一号库" },
        { name: "电力电缆", value: "0.38 亿元", city: "国网沈阳供电公司", station: "沈阳浑南智慧库" },
        { name: "组合电器", value: "0.32 亿元", city: "国网大连供电公司", station: "大连瓦房店中心库" },
        { name: "电能表", value: "0.25 亿元", city: "国网鞍山供电公司", station: "鞍山中心库房" },
        { name: "避雷器", value: "0.18 亿元", city: "国网抚顺供电公司", station: "抚顺物资仓库" },
        { name: "熔断器", value: "0.12 亿元", city: "国网本溪供电公司", station: "本溪生产库" },
      ],
    },
    inventoryRankingPanel: {
      ...
      icon: Store,
      items: [
        { name: "沈阳铁西中心库", value: "4.22 亿元", city: "国网沈阳供电公司", department: "物资管理部" },
        { name: "大连金普一号库", value: "3.82 亿元", city: "国网大连供电公司", department: "物资管理部" },
        { name: "鞍山钢铁备件库", value: "3.12 亿元", city: "国网鞍山供电公司", department: "设备管理部" },
        { name: "抚顺石油专用库", value: "2.82 亿元", city: "国网抚顺供电公司", department: "基建部" },
        { name: "本溪钢铁一号库", value: "2.52 亿元", city: "国网本溪供电公司", department: "物资管理部" },
      ],
    },
    cityInventoryPanel: {
  ...
  shenyang: {
    ...
    metrics: [
      ...
      { label: "材料站累计入库金额", value: "¥ 4.25", unit: "亿元", icon: ArrowDownCircle, status: "normal" },
      { label: "材料站累计出库金额", value: "¥ 3.12", unit: "亿元", icon: ArrowUpCircle, status: "normal" },
    ...
    materialRankingPanel: {
      ...
      icon: Boxes,
      items: [
        { name: "配电变压器", value: "0.45 亿元", city: "国网沈阳供电公司", station: "沈阳铁西中心库" },
        { name: "高压电缆", value: "0.38 亿元", city: "国网沈阳供电公司", station: "沈阳浑南智慧库" },
        { name: "组合电器", value: "0.32 亿元", city: "国网沈阳供电公司", station: "沈阳大东生产库" },
        { name: "智能电表", value: "0.25 亿元", city: "国网沈阳供电公司", station: "沈阳于洪物流仓" },
        { name: "充电桩模块", value: "0.18 亿元", city: "国网沈阳供电公司", station: "沈阳和平储备站" },
        { name: "互感器", value: "0.15 亿元", city: "国网沈阳供电公司", station: "沈阳苏家屯中心库" },
        { name: "断路器", value: "0.12 亿元", city: "国网沈阳供电公司", station: "沈阳康平应急站" },
        { name: "避雷器", value: "0.10 亿元", city: "国网沈阳供电公司", station: "沈阳法库备件库" },
        { name: "隔离开关", value: "0.08 亿元", city: "国网沈阳供电公司", station: "沈阳新民物流仓" },
        { name: "电力电容器", value: "0.05 亿元", city: "国网沈阳供电公司", station: "沈阳辽中储备站" },
      ],
    },
    inventoryRankingPanel: {
      title: "Top 5 综合材料站 库存金额",
      icon: Store,
      items: [
        { name: "沈阳铁西中心库", value: "4.20 亿元", city: "国网沈阳供电公司", department: "物资管理部" },
        { name: "沈阳浑南智慧库", value: "3.80 亿元", city: "国网沈阳供电公司", department: "设备管理部" },
        { name: "沈阳大东生产库", value: "3.10 亿元", city: "国网沈阳供电公司", department: "物资管理部" },
        { name: "沈阳于洪物流仓", value: "2.80 亿元", city: "国网沈阳供电公司", department: "基建部" },
        { name: "沈阳和平储备站", value: "2.50 亿元", city: "国网沈阳供电公司", department: "后勤保障部" },
      ],
    },
    cityInventoryPanel: {
      title: "材料站按归属部门分布",
